...
export default function NFTCategory(props: PropNFTCategory) {
    let {img=nftImg,label, className} = props;
  return (
    <div className={`rounded-[20px] relative overflow-hidden ${className} transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105`}>
